...
<!-- 						<li><a _href="member=del.jsp"> <i class="iconfont">&#xe6a7;</i>
 ...
 -->
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe6ce;</i>
					...
					<ul class="sub-menu">
						<li><a _href="echarts1.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>拆线图</cite>
						</a></li>
						<li><a _href="echarts2.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>柱状图</cite>
						</a></li>
						<li><a _href="echarts3.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>地图</cite>
						</a></li>
						<li><a _href="echarts4.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>饼图</cite>
						</a></li>
						<li><a _href="echarts5.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>雷达图</cite>
						</a></li>
						<li><a _href="echarts6.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>k线图</cite>
						</a></li>
						<li><a _href="echarts7.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>热力图</cite>
						</a></li>
						<li><a _href="echarts8.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>仪表图</cite>
						</a></li>
					</ul></li>
				<li><a href="javascript:;"> <i class="iconfont">&#xe723;</i>
